...
<div class="col-sm-12">
<div class="well">
<center><h1 style="color:white;"><strong>Facemash</strong></h1></center>
</div>
</div>
</div>
<div class="row">
    ...
    <input type="password" name="pass" placeholder="New Password" id="password" class="form-control" required>
    </div><br>
   
    <div class="input-group">
    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
    <input type="password"  class="form-control" id="password" name="pass1" placeholder="Re-enter New Password" required>
    </div><br>
...
if(isset($_POST['change']))
{
    ...
    if($pass == $pass1)
    {
        if(strlen($pass)>=6 && strlen($pass) <60)
        {
            ...
            echo "<script>alert('Your password must be greator than 6 character')</script>";
        }
    }
    else{
