...
function get_posts(){
 ...
 function single_post(){
	 if(isset($_GET['post_id']));
	 {
				...
				<div class='row'>
					...
					<div id='posts' class='col-sm-6'>
						<div class='row'>
							...
							<img src='users/$user_image' style='height:100px;width:100px' class='img-circle'>
		 </a>
							</div>
							<div class='col-sm-6'>
								<h3><a style='text-decoration:none; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
				...
				<div class='row'>
					...
					<div id='posts' class='col-sm-6'>
						<div class='row'>
							<div class='col-sm-2'>
							<a href='user_profile.php?u_id=$user_id'>
							<img src='users/$user_image' style='height:100px;width:100px' class='img-circle'>		 </a>
							</div>
							<div class='col-sm-6'>
								<h3><a style='text-decoration:none; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
								<h4><small style='color:black;'>Updated a post on <strong>$post_date</strong></small></h4>
		...
		include("comments.php");
			...
			<textarea placeholder='Write your comment here!' class='pb-cmnt-textarea' id='pb-cmnt-textarea' name='comment' ></textarea>
 ...
 function search_user()
 {
	 ...
	 while($row_user = mysqli_fetch_array($run_user))
	 {
		 ...
		 <div class='col-sm-6'>
		 <div class='row' id='find_people' style='border:5px solid #e6e6e6;
		 padding:40px 50px;'>
		 <div class='col-sm-4'>
		 <a href='user_profile.php?u_id=$user_id'>
		 <img src='users/$user_image' width='150px' height='140px' class='img-circle' title='$username' style='float:left;margin:1px;'>
		 </a>
		 </div><br><br>
		 <div class='col-sm-6'>
